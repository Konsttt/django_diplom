...
class Shop(models.Model):
    ...
    # один менеджер - один магазин (! у одного менеджера не может быть несколько магазинов)
...
class Contact(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "Список контактов пользователя"  # может быть несколько адресов доставки
...
class UploadFiles(models.Model):
    user = models.ForeignKey(User, verbose_name='Пользователь',
                             related_name='upload_files', blank=True,
                             on_delete=models.CASCADE)
    ...
    def __repr__(self):
        return 'UploadFiles(%s, %s)' % (self.name, self.file)
